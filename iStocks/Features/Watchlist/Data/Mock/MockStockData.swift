...
struct MockStockData {
    ...
    static let allStocks: [Stock] = {
        let rawStocks: [Stock] = [
            ...
            Stock(id: UUID(), symbol: "VZ", name: "Verizon Communications Inc.", price: 55.00, previousPrice: 54.00, isPriceUp: true, qty: 90, averageBuyPrice: 50, sector: "Communication"),
            Stock(id: UUID(), symbol: "BRK.B", name: "Berkshire Hathaway Inc.", price: 450.00, previousPrice: 440.00, isPriceUp: true, qty: 100, averageBuyPrice: 400, sector: "Consumer Discretionary"),
            Stock(id: UUID(), symbol: "WMT", name: "Walmart Inc.", price: 104.00, previousPrice: 103.00, isPriceUp: true, qty: 110, averageBuyPrice: 90, sector: "Consumer Discretionary"),
